...
public abstract class MathFieldEditorDecorator {
	 ...
	 */
	public MathFieldEditorDecorator(MathFieldEditor editor) {
		this.editor = editor;
	...
	protected void setForegroundColor(GColor foregroundColor) {
		mathField.setForegroundCssColor(StringUtil.toHtmlColor(foregroundColor));
	}
