		...
		if ($wnd.gapi) {
			...
			$wnd.gapi
					.load(
							...
							{
								'callback' : function() {
									@org.geogebra.common.util.debug.Log::debug(Ljava/lang/Object;)("picker loaded");
								}
							});
			...
			request
					.execute(function(resp) {
						if (!resp.error) {
							...
							@org.geogebra.common.util.debug.Log::debug(Ljava/lang/Object;)("Error saving to Google Drive: " + resp.error);
